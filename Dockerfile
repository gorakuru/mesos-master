...
RUN wget http://www.apache.org/dist/mesos/0.23.0/mesos-0.23.0.tar.gz && tar -zxvf mesos-0.23.0.tar.gz && RUN cd mesos-0.23.0 && mkdir build && cd build && ../configure && make
